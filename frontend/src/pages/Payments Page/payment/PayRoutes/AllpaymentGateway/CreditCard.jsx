...
const CreditCard = () => {
  return (
    <div>
        <Flex>  <Heading sx={{ fontSize: "16px", color: "rgb(0, 75, 142)", padding: "0px 200px 10px 0px", fontWeight: "700", borderBottom: "1px solid rgb(209, 209, 209)" }}>Select Payment Method</Heading>
        <Box>
            <Image widht="20%" src="https://www.reliancedigital.in/build/client/images/debit-card-icons.png"/>
        </Box>
        </Flex>
...
<Select sx={{ padding: "0px 90px", widht: "100%" }} placeholder='Select a Bank'>
